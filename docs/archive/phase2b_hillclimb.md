> **ARCHIVED 2026-04-28.** Superseded by Phase 2g ([`docs/phase2g_plan.md`](../phase2g_plan.md)). Phase 2b's contrast-pair hill-climbing methodology hit a lexical-surface ceiling that motivated the substrate change to SAE features.
>
