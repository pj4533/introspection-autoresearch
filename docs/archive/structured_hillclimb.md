> **ARCHIVED 2026-04-28.** Superseded by Phase 2g ([`docs/phase2g_plan.md`](../phase2g_plan.md)). Phase 2f's three-slot scheduler over contrast pairs is replaced by Phase 2g's four-slot scheduler over SAE features. The slot-composition idea survived; the substrate did not.
>
