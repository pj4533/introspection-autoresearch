> **ARCHIVED 2026-04-28.** Superseded by Phase 2g ([`docs/phase2g_plan.md`](../phase2g_plan.md)). Phase 2c's unified autoresearch wrapper (Sonnet judge + Opus researcher) was paused for cost reasons; replaced by the all-local pipeline that Phase 2g extends.
>
